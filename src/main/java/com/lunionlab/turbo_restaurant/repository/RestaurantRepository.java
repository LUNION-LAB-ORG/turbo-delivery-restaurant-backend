...
public interface RestaurantRepository extends JpaRepository<RestaurantModel, UUID> {
    ...
    List<RestaurantModel> findAllByStatusNotInAndDeletedOrderByDateCreationDesc(List<Integer> status, Boolean deleted);

    Page<RestaurantModel> findByStatusNotInAndDeletedOrderByDateCreationDesc(List<Integer> status, Boolean deleted,
            Pageable page);

    Page<RestaurantModel> findByStatusAndDeletedOrderByDateCreationDesc(Integer status, Boolean deleted, Pageable page);
